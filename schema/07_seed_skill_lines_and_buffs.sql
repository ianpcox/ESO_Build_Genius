...
-- =============================================================================
-- Ensure at least one game build exists (Default + Update 48 for current patch)
-- =============================================================================
INSERT OR IGNORE INTO game_builds (label) VALUES ('Default');
INSERT OR IGNORE INTO game_builds (label) VALUES ('Update 48');
...
-- =============================================================================
-- Example set and set bonus for first game_build (Kinras 5pc = Major Berserk)
...
INSERT OR IGNORE INTO set_bonuses (game_build_id, game_id, num_pieces, set_bonus_desc, effect_type, magnitude)
SELECT (SELECT id FROM game_builds ORDER BY id LIMIT 1), 1, 5, 'When you deal Critical Damage, you gain Major Berserk', 'damage_done', 0.10;
INSERT OR IGNORE INTO buff_grants_set_bonus (game_build_id, buff_id, game_id, num_pieces)
SELECT (SELECT id FROM game_builds ORDER BY id LIMIT 1), 2, 1, 5;
